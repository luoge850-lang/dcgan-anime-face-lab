...
The true baseline is `00_baseline`: a plain DCGAN with no added attention, wavelet, FFT, Canny, Laplacian, spectral-normalization, Hinge, or R1 module. Its Phase 2 legacy FID is 109.40.
