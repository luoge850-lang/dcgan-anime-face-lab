...
The current handoff package is `DCGAN_Interview_GitHub_Handoff_2026-09-04`, released as `v0.10.1-handoff-2026-09-04`; the earlier v0.9 and v0.10 states remain historical.
...
- Default branch: `main`
- Current handoff tag: `v0.10.1-handoff-2026-09-04`
