"""
================================================================================
 G强化实验 00_Baseline: SNGAN Standard Recipe — G强化实验基准线
================================================================================
 这是深度调优阶段 13_D_SN_Hinge 的复现：
   D: Spectral Norm on Conv+penLin, last Linear free, NO Sigmoid
   G: Standard DCGAN 5-layer ConvTranspose
   Loss: Hinge Loss
   Dataset: 10,000 samples (expanded from previous 8,000)

 Serves as the BASELINE for all G-strengthening experiments.
 Expected FID: ~96

 参考技术: SNGAN (Miyato et al., ICLR 2018)
================================================================================
"""
...
DATASET_LIMIT = 10000  # Expanded from 8000
...
# =============================================================================
# Generator — Standard DCGAN 5-layer ConvTranspose (Baseline)
#   Architecture: 128 → 256(4×4) → 128(8×8) → 64(16×16) → 32(32×32) → 3(64×64)
#   This is the exact same Generator from depth-tuning 13_D_SN_Hinge.
# =============================================================================
...
# =============================================================================
# Discriminator — Baseline: SN(Conv+penLin), lastLin FREE, NO Sigmoid
#   This is the proven optimal D configuration from depth-tuning.
#   Constrains D's Lipschitz constant via Spectral Normalization.
#   Hinge Loss needs raw logits → no Sigmoid.
# =============================================================================
...
# =============================================================================
# Metrics — identical to depth-tuning standard
# =============================================================================
class FIDCalculator:
...
def main():
    ...
    del g_tmp,d_tmp
    print(f"\n{'='*55}")
    print(f"  {EXPERIMENT_NAME}: Baseline (SN+Hinge + Standard DCGAN G)")
    print(f"  G: {gp:,} params (5-layer ConvTranspose) | D: {dp:,} params (SN+Hinge)")
    print(f"  Dataset: {DATASET_LIMIT} images | Device: {DEVICE} | Epochs: {EPOCHS}")
    print(f"{'='*55}\n")
    ...
    # Loss curves — 3-panel visualization
    ...
    metrics={"experiment_name":EXPERIMENT_NAME,"epochs":EPOCHS,"dataset_size":DATASET_LIMIT,
        "technique":"Baseline: SN+Hinge D + Standard DCGAN G (5-layer ConvTranspose). Reference for G-strengthening experiments.",
    ...
    print(f"\n{'='*55}")
    print(f"  Complete: {EXPERIMENT_NAME}  FID={fid:.2f}")
