"""
================================================================================
 13_D_SN_Hinge: SN + Hinge Loss — "SNGAN standard recipe"
================================================================================
 Combines 11_D_SN and 12_D_Hinge: Spectral Norm in D + Hinge Loss.
 This is the standard SNGAN recipe (Miyato et al., ICLR 2018) —
 widely considered the most stable GAN training configuration.

 Why SN + Hinge together:
   SN constrains D's Lipschitz constant → prevents D from overfitting.
   Hinge provides linear gradients → no saturation when D is confident.
   Together they form a self-regulating system: SN keeps D smooth,
   Hinge gives G consistent feedback regardless of D's current strength.
   This is the configuration that made SNGAN the SOTA in 2018.

 Predicted FID: 88-98 (Baseline=109.40, 11_D_SN predicts 95-105, 12_D_Hinge predicts 100-108)
================================================================================
"""
...
# =============================================================================
# [13_D_SN_Hinge CHANGE] Discriminator + Spectral Norm + no Sigmoid (Hinge needs logits)
# =============================================================================
...
def main():
    ...
    del g_tmp,d_tmp
    print(f"\n{'='*55}")
    print(f"  {EXPERIMENT_NAME}: SN + Hinge (SNGAN standard recipe)")
    print(f"  G: {gp:,} params (standard) | D: {dp:,} params (+SN)")
    ...
    metrics={"experiment_name":EXPERIMENT_NAME,"epochs":EPOCHS,"dataset_size":len(image_paths),
        "technique":"SNGAN: Spectral Norm in D + Hinge Loss (standard G)",
