"""
FT-A50: Exp11 Fine-Tuning ? 50% ?? + 50% SDXL (2K+2K), 100 Epoch
================================================================================
Kaggle GPU (T4?2), Internet ON?? ?? ~2,000 ????? SDXL ???

??:
  - Kaggle Input ??? Exp11 ?? (generator_ema_final.pth, discriminator_final.pth)
  - Kaggle Input ??????? SDXL ?? (?2,000 ?, accepted_manifest.csv + accepted_64/)
