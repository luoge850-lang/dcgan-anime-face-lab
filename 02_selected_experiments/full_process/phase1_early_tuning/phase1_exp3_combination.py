"""
================================================================================
 DCGAN Experiment 3: Combination Augmentation
   Combo1: Flip + Color
   Combo2: Color + Sharpen (p=0.2)
   Combo3: Flip + Sharpen (p=0.2)
   Combo4: Flip + Color + Sharpen (p=0.2)
   Combo5: Flip + Color + Sharpen + Denoise (p=0.2)
================================================================================
"""
...
def main():
    ...
    def tf_c1(): return transforms.Compose([transforms.Resize((IMAGE_SIZE,IMAGE_SIZE)),transforms.RandomHorizontalFlip(p=0.5),transforms.ColorJitter(brightness=0.2,contrast=0.2),transforms.ToTensor(),transforms.Normalize((0.5,0.5,0.5),(0.5,0.5,0.5))])
    def tf_c2(): return transforms.Compose([transforms.Resize((IMAGE_SIZE,IMAGE_SIZE)),transforms.ColorJitter(brightness=0.2,contrast=0.2),EdgeSharpen(prob=0.2),transforms.ToTensor(),transforms.Normalize((0.5,0.5,0.5),(0.5,0.5,0.5))])
    def tf_c3(): return transforms.Compose([transforms.Resize((IMAGE_SIZE,IMAGE_SIZE)),transforms.RandomHorizontalFlip(p=0.5),EdgeSharpen(prob=0.2),transforms.ToTensor(),transforms.Normalize((0.5,0.5,0.5),(0.5,0.5,0.5))])
    def tf_c4(): return transforms.Compose([transforms.Resize((IMAGE_SIZE,IMAGE_SIZE)),transforms.RandomHorizontalFlip(p=0.5),transforms.ColorJitter(brightness=0.2,contrast=0.2),EdgeSharpen(prob=0.2),transforms.ToTensor(),transforms.Normalize((0.5,0.5,0.5),(0.5,0.5,0.5))])
    def tf_c5(): return transforms.Compose([transforms.Resize((IMAGE_SIZE,IMAGE_SIZE)),transforms.RandomHorizontalFlip(p=0.5),transforms.ColorJitter(brightness=0.2,contrast=0.2),EdgeSharpen(prob=0.2),MedianDenoise(prob=0.2),transforms.ToTensor(),transforms.Normalize((0.5,0.5,0.5),(0.5,0.5,0.5))])

    run_experiment("exp3_c1_flip_color","exp3_combination",100,tf_c1,image_paths,fixed_noise)
    run_experiment("exp3_c2_color_sharpen","exp3_combination",100,tf_c2,image_paths,fixed_noise)
    run_experiment("exp3_c3_flip_sharpen","exp3_combination",100,tf_c3,image_paths,fixed_noise)
    run_experiment("exp3_c4_flip_color_sharpen","exp3_combination",100,tf_c4,image_paths,fixed_noise)
    run_experiment("exp3_c5_flip_color_sharpen_denoise","exp3_combination",100,tf_c5,image_paths,fixed_noise)
